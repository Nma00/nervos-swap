import { ChainId, JSBI, Percent, Token, WDEV } from 'nervoswap-sdk'
import { AbstractConnector } from '@web3-react/abstract-connector'
import { routerv2 as gwRouterv2 } from '../gw_address.json'
import { routerv2 as ropstenRouterv2 } from '../ropsten_address.json'
...
export const ROUTER_ADDRESS: { [key: string]: string } = {
  [ChainId.GW]: gwRouterv2,
  [ChainId.ROPSTEN]: ropstenRouterv2,
}
...
export const MIN_CKB: JSBI = JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(6)) // .01 CKB
